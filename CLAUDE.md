...
See `AGENTS.md` for full version management and release process details. Quick reference: `bun version patch` bumps version, auto-syncs `manifest.json`/`versions.json`, commits, and tags. Tag push triggers GitHub Actions release.
